...
class MainSimulador(Gtk.Application):
    def __init__(self):
        super().__init__(application_id="org.proyecto_final.utal")
    ...
    def on_activate(self, app):
        ...
        etiqueta = Gtk.Label(label="Aquí se mostrará la simulación de la colonia.")
        self.ventana.set_child(etiqueta)
